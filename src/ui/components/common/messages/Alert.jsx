    ...
    <>
      {isVisible && (
        <div className="container py-16">
          <div className="flex max-w-[655px] items-center rounded-md border-l-[6px] border-l-[#228E8D] bg-white p-5 pl-6 ">
            <div className="mr-5 flex h-[36px] w-full max-w-[36px] items-center justify-center rounded-full bg-red">
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
            ...
            <div className="flex w-full items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 max-w-96">{message}</p>
              </div>
              <div>
